...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/eoinoconnell04/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        8m20.141s          |          1:04.12          | 
| `pg_normalized_batch`  |        1m48.233s          |          0:14.31          | 
| `pg_denormalized`      |        0m17.475s          |          0:04.11          | 
